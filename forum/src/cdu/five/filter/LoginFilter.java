...
@WebFilter(filterName = "LoginFilter",urlPatterns={"/*"},initParams = {@WebInitParam(name = "permitUrls", value = "/,/user/login.jsp,/user/login,/validCode,/user/register,/user/register.jsp")})
