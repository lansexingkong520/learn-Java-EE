...
public class UpUtils {
    ...
    public static String upfile(MultipartFile file, HttpServletRequest request) {
        //1. 获取文件命名
        //2. 判断当前文件类型,并且设置存放路径
        //3, 判断存放路劲是否存在,如果不存在,则自动创建
        //4. 创建文件输出流
        //5. 调用write()通过二进制的方式写入对应文件中
        //6. flush
        //7. 关闭流close
        //获取当前文件的名称
        ...
        if (originalFilename.endsWith(".mp4")) {
            ...
            localPath ="E:\\IdeaProjects\\pet\\src\\main\\resources\\static\\video\\";
            ...
            localPath ="E:\\IdeaProjects\\pet\\src\\main\\resources\\static\\img\\";
            ...
            localPath ="E:\\IdeaProjects\\pet\\src\\main\\resources\\static\\audio\\";
